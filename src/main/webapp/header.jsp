			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex" role="search" style="position: relative;display: block;float: right;">
					...
					<%
						...
						if(khachHang==null){
					%>
						<a class="btn btn-primary" style="white-space: nowrap;" href="khachhang/login.jsp">
							Đăng nhập
						</a>
					<%} else { %>
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
						<li class="nav-item dropdown dropstart"><a
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="<%=url %>/khachhang/changePhoto.jsp">Thay đổi ảnh avatar</a></li>
								<li><a class="dropdown-item" href="<%=url %>/khachhang/changeInfo.jsp">Thay đổi thông tin</a></li>
								<li><a class="dropdown-item" href="<%=url %>/khachhang/changePass.jsp">Đổi mật khẩu</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="<%=url %>/khachHangController?hanhDong=dang-xuat">Thoát tài khoản</a></li>
							</ul></li>
					</ul>				
